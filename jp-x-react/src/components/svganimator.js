...
import { Parallax, ParallaxLayer, IParallax } from '@react-spring/parallax'
  export default function Svganimator() {
    ...
    return (
        <>
         <svg className="blob" viewBox="-50 -50 100 100" id="sw-js-blob-svg" xmlns="http://www.w3.org/2000/svg" version="1.1">
         <defs> 
            <linearGradient id="sw-gradient" x1="0" x2="1" y1="1" y2="0">
                <stop id="stop1" stop-color="rgba(204, 55, 255, 1)" offset="0%"></stop>
                <stop id="stop2" stop-color="rgba(41.84, 251.39, 255, 1)" offset="100%"></stop>
            </linearGradient>
          </defs>
